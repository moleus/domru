...
import (
	...
	"github.com/mrqmpan/domru/cmd/controllers"
	"github.com/mrqmpan/domru/pkg/auth"
	"github.com/mrqmpan/domru/pkg/authorizedhttp"
	...
	"github.com/mrqmpan/domru/pkg/logging"
	"github.com/mrqmpan/domru/pkg/reverseproxy"
	"github.com/mrqmpan/domru/pkg/tokenmanagement"
